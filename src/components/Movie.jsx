          ...
          !time.hasExpired ? (
            ...
            <>
              <div className="heading">
                <i className="heading-item far fa-times-circle fa-5x"></i>
                <h2 className="heading-item">No movie found... Try it again</h2>
              </div>
        ...
        <div className="movie-items">
          ...
          <div className="movie-item rate-fav">
...

            {
              ...
              fav.find((f) => f.id === id) ? (
                <button
                  className="fav-btn fav-btn-disable"
          ...
          <span className="movie-item">
            {
              ...
              length === 0 ? Movie.defaultProps.length : length
            }
          </span>
          <ul className="movie-item">
            ...
            {cast.map((p) => (
              <li>
                <span className="movie-actor">{p.actor}</span> - {p.character}
              </li>
            ))}
          </ul>
        </div>
